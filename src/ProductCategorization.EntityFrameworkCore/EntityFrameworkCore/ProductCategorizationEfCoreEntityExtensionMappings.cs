...
public static class ProductCategorizationEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE ProductCategorizationModuleExtensionConfigurator CLASS (in the Domain.Shared project)
